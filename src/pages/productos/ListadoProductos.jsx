      ...
      {editar ? (
        <>
          ...
          <td className="descripcion">
            <textarea
              name="descripcion"
              className="edit_input textarea_edit"
          ...
          <td>
            <input
              type="number"
              name="tamano"
              className="edit_input numero"
              value={infoNuevoProducto.tamano}
              onChange={(e) =>
                setInfoNuevoProducto({
                  ...infoNuevoProducto,
        ...
        <>
          <td className="acciones tr">
            <button
              ...
              className="edit_btn"
            >
              <span className="material-icons edit">done</span>
            </button>
            <button
              title="Cancelar"
            ...
            >
              <span className="material-icons delete">clear</span>
            </button>
          </td>
        </>
      ) : (
